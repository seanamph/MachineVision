...
namespace MyApp
{
    public class NImgProcessDLL
    {
        ...
        [DllImport("NImgProcessDLL.dll", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode, EntryPoint = "Small_Transform")]
        public extern static bool Small_Transform(IntPtr m_SrcImg, IntPtr m_OutImg, IntPtr m_ImgPro);

        [DllImport("NImgProcessDLL.dll", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode, EntryPoint = "FromImageToVector")]
        public extern static bool FromImageToVector(IntPtr m_SrcImg, ref Byte m_Vector, int element_num, IntPtr m_ImgPro);

        [DllImport("NImgProcessDLL.dll", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode, EntryPoint = "Split_Image")]
        public extern static bool Split_Image(IntPtr m_SrcImg, int start_x, int start_y, int split_wid,
                                              int split_hei, IntPtr m_SubImg, IntPtr m_ImgPro);
