...
INLINE __m128i _mm_subs_epi8 (__m128i a, __m128i b)
{
    return (__m128i)vsubq_s8((int8x16_t) a, (int8x16_t) b);
}
 ...
 *                abs
 ***************************************************************************/
INLINE __m128i _mm_abs_epi16(__m128i a)
{
    return (__m128i)vabsq_s16((int16x8_t) a);
}
...
{
    return (__m128i)vcltq_s8((int8x16_t) a,( int8x16_t) b);
}
...
INLINE __m128i _mm_srli_epi32(__m128i a, int count)
{
//	todo :
//	if immediate
    return (__m128i)vshlq_u32((uint32x4_t)a, vdupq_n_s32(-count));
}
